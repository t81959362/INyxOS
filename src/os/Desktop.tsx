...
const DesktopContent: React.FC = () => {
  ...
  React.useEffect(() => {
    ...
    // Listen for global lock event
    const handleGlobalLock = () => setLocked(true);
    window.addEventListener('os-lock', handleGlobalLock);
    reset();
    return () => {
      clearTimeout(timer);
      window.removeEventListener('mousemove', reset);
      window.removeEventListener('keydown', reset);
      window.removeEventListener('os-lock', handleGlobalLock);
    };
  }, [locked]);
