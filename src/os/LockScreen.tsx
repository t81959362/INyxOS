...
import { LockScreenStocksAndNews } from './widgets/LockScreenStocksAndNews';
  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: '100%' }}>
      <div className="lock-screen-root">
        ...
        />
        {/* Stocks and News at bottom */}
        <LockScreenStocksAndNews />
        <div style={{
          position: 'relative',
          zIndex: 1,
      ...
      {/* Small stocks and news boxes at bottom, Windows 11 style */}
      <LockScreenStocksAndNews />
    </div>
  );
};
