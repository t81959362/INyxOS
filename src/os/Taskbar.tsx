...
import NexaAiIcon from '../assets/Nexa AI.ico';
  ...
  const trayIcons: TrayIcon[] = [
    {
      ...
      icon: (
        <span title="Notifications" onClick={() => setShowPopover(v => !v)} style={{ position: 'relative' }}>
          <svg width="1.1em" height="2em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      id: 'network',
      icon: (
        <span title="Nexa" onClick={() => setShowAI(v => !v)} style={{ cursor: 'pointer', position: 'relative', left: '-4px', top: '1.0px' }}>
          <img src={NexaAiIcon} alt="Nexa AI" style={{ width: 35, height: 20, objectFit: 'contain' }} />
        </span>
      ),
